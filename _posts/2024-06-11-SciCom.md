...
---
<figure>
<img src="/assets/img/Elemental_Music.png" alt="A musical bar of a scale where each note is replaced with a symbol from the periodic table of elements"  width="400" height="300"> 
</figure>

# Communicating as a Scientist: Lessons from Singers
...
### Identify Tension and Let It Go
...
### Warm Up 5-10 Minutes Before Your Talk
...
### Think About the Natural Break Points in Your Talk
...
### Don’t Be Afraid to Play with Sound
...
There is really so much to keep track of during your own presentation - Maybe someone is coming in late, or your tough-to-read colleague is sitting in the front row, or the mouse gets frozen on the screen. It can shake out all of the prep work you have done - and that’s totally normal! To get through it, try to:
